...
// якщо негативна відповідь, інформувати користувача (нет изображений, соответствующих запросу)
...
// якщо закінчився список з картинок, інформувати користувача (достигли конца результатов поиска)
function infoResult() {
  iziToast.info({
    maxWidth: '432px',
    messageSize: '16px',
